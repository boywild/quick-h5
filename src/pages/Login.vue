  ...
  <div class="page page-login">
    <div class="login-page-inner">
      ...
      <el-form ref="loginForm" :model="formData" :rules="formRules" label-width="0px">
        ...
        <el-form-item v-if="type === 'register'" prop="email">
          <el-input v-model="formData.email" autocomplete="off" placeholder="请输入邮箱" @keyup.enter="doLogin">
            <template #prefix>
              <span class="iconfont icon-mail-copy"></span>
            </template>
          </el-input>
        </el-form-item>
        <el-form-item prop="password">
          ...
          >
            ...
            <template #suffix>
              <span class="cursor-pointer" @mousedown="mousedownPassword">
          ...
          >
            ...
            <template #suffix>
              <span class="cursor-pointer" @mousedown="mousedownText">
