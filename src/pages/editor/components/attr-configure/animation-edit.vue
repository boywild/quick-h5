    ...
    <el-scrollbar class="components-attr-edit">
      <div v-if="activeElementUUID" class="attr-edit-inner">
        <div class="animate-edit-btn-wrapper">
          <el-button type="primary" icon="el-icon-plus" @click="addAnimate">添加动画</el-button>
          <el-button icon="el-icon-caret-right" @click="runAnimate(undefined)">预览动画</el-button>
        </div>
              ...
              <div class="el-animate-item">
                <div class="attr-item-edit-wrapper">
                  ...
                  <div class="col-2 attr-item-edit-input">
                    <el-input-number v-model="item.duration" controls-position="right" :min="0" :step="0.1" />
                  </div>
                </div>
                <div class="attr-item-edit-wrapper">
                  <p class="attr-item-title">动画延迟：</p>
                  <div class="col-2 attr-item-edit-input">
                    <el-input-number v-model="item.delay" controls-position="right" :min="0" :step="0.1" />
                  </div>
                </div>
                <div class="attr-item-edit-wrapper">
                  <p class="attr-item-title">循环次数：</p>
                  <div class="col-2 attr-item-edit-input">
                    <el-input-number v-model="item.interationCount" controls-position="right" />
                    <div class="attr-item-edit-input-des">次数</div>
                  </div>
                  <div class="col-2 attr-item-edit-input">
                    <el-checkbox v-model="item.infinite" label="infinite" border>循环播放</el-checkbox>
                  </div>
                </div>
              </div>
            </el-collapse-item>
