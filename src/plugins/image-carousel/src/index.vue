...
<template>
  <div class="qk-image-carsousel">
    <!--异步加载轮播图的情况;-->
    <Swiper v-if="imageSrcList.length > 0" class="image-carsousel-swiper" :auto-play="true" :show-indicator="true" :interval="interval" duration="500">
      <Slide v-for="(item,index) in imageSrcList" :key="index" class="image-carsousel-slide">
